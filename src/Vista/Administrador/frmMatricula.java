...
public class frmMatricula extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADMINISTRACION DE MATRICULA");

        jPanel2.setBackground(new java.awt.Color(0, 153, 204));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro de Matricula", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12), new java.awt.Color(0, 51, 153))); // NOI18N
        ...
        txtIdMatricula.setForeground(new java.awt.Color(0, 51, 153));
        ...
        jLabel10.setText("Apellidos del Estudiante:");
        ...
        txtApellidosEstudiante.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        txtApellidosEstudiante.setForeground(new java.awt.Color(0, 51, 153));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtNombreC, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                    .addComponent(txtNombrePro)
                    .addComponent(txtApeProf)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addComponent(txtNombreEstudiante, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(txtIdEstudiante, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Estudiantes", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12), new java.awt.Color(0, 51, 153))); // NOI18N

        tablaEstudiante.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tablaEstudiante.setForeground(new java.awt.Color(0, 51, 153));
        ...
        tablaCursos.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tablaCursos.setForeground(new java.awt.Color(0, 51, 153));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Lista de Matricula", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 12), new java.awt.Color(0, 51, 153))); // NOI18N

        tablaMatricula.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tablaMatricula.setForeground(new java.awt.Color(0, 51, 153));
        ...
        jScrollPane4.setViewportView(tablaMatricula);
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        try {
            this.crearMatricula(idEst, idCurso, idProf);
            mostrarMatricula();
    ...
    private void tablaEstudianteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaEstudianteMouseClicked
        ...
        txtIdEstudiante.setText(tablaEstudiante.getValueAt(fila, 0).toString());
        txtNombreEstudiante.setText(tablaEstudiante.getValueAt(fila, 1).toString());
        txtApellidosEstudiante.setText(tablaEstudiante.getValueAt(fila, 2).toString());
    ...
    private void tablaCursosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaCursosMouseClicked
        ...
        txtIdCurso.setText(tablaCursos.getValueAt(fila, 0).toString());
        txtNombreC.setText(tablaCursos.getValueAt(fila, 1).toString());
        txtIdProf.setText(tablaCursos.getValueAt(fila, 2).toString());
        txtNombrePro.setText(tablaCursos.getValueAt(fila, 3).toString());
        txtApeProf.setText(tablaCursos.getValueAt(fila, 4).toString());
        btnAgregar.setEnabled(true);
    ...
    public void crearMatricula(int idEst, int idCurso, int idProf) {
        MatriculaVO matricula = new MatriculaVO();
        modelo = new MatriculaDAO();
        matricula.setIdEstudiante(idEst);
        matricula.setIdCurso(idCurso);
        matricula.setIdProfesor(idProf);

        modelo.crearMatricula(matricula);
    }
    ...
    void mostrarEstudiantes() {
        try {
            ...
            tabla = matricula.mostrarEstudiantes();
    ...
    void mostrarMatricula() {
        try {
            DefaultTableModel tabla;
            MatriculaDAO matricula = new MatriculaDAO();
            tabla = matricula.mostrarMatricula();
            tablaMatricula.setModel(tabla);
        } catch (Exception e) {
        }
    }
